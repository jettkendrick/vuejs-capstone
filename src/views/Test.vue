    ...
    <section id="blog" class="qdr-blog post-radius gray6 post-shadow lh-lg py bg-gray2">
        ...
        <div class="container-md">
            ...
            <div id="posts" class="cbp">
                ...
                <!-- Post -->
                <a v-for="outfit in outfits" href="blog-single-01.html"  class="cbp-item art music">
                    <!-- Mark -->
                    <div class="basic-mark to-left bold uppercase font-10 radius-lg bg-info white">fart</div>
